...
const DEFAULT_OPTIONS = {
  ...
  availableIcon: video.badge.checkmark,
  availableIconColor: '#147bff',
  availableStyle: 'good',
  comingContent: 'Coming Soon ➟ #REGION_FLAG# #REGION_NAME#',
  comingIcon: video.badge.checkmark,
  comingIconColor: '#147bff',
  comingStyle: 'info',
  notAvailableContent: 'Not unlocked Disney+',
  notAvailableIcon: video.badge.checkmark,
  notAvailableIconColor: '#147bff',
  notAvailableStyle: 'alert',
  errorContent: '检测失败，请稍后重试',
  errorIcon: video.badge.checkmark,
  errorIconColor: '#147bff',
  errorStyle: 'error',
  timeout: 3000,
}
